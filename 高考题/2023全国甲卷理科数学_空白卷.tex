...
\begin{tightcenter}\includegraphics[width=2.3cm]{figures/2023_jia_li_q3.png}\end{tightcenter}
...
（2）若直线$AA_1$与$BB_1$距离为$2$，求$AB_1$与平面$BCC_1B_1$所成角的正弦值. 
\end{minipage}\hfill
...
（i）求$40$只小鼠体重的中位数$m$，并完成下面$2\times2$列联表：
\begin{tightcenter}
\begin{tabular}{|c|c|c|}
\hline & $<m$ & $\geq m$ \\\hline
对照组 & & \\\hline
...
\end{tabular}
\end{tightcenter}
（ii）根据$2\times2$列联表，能否有$95\%$的把握认为药物对小鼠生长有抑制作用. 
...
（2）设$C$的焦点为$F$，$M,N$为$C$上两点，且$\vec{MF}\cdot\vec{NF}=0$，求$\triangle MNF$面积的最小值. 
