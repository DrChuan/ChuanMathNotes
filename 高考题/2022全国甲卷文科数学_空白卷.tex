...
\begin{tightcenter}\includegraphics[width=10.5cm]{figures/2022_jiawen_q2.png}\end{tightcenter}
则
...
\begin{tightcenter}\includegraphics[width=5cm]{figures/2022_jiawen_q4.png}\end{tightcenter}
...
\graphchoices{\includegraphics[width=4.3cm]{figures/2022_jiawen_q7_A.png}}{\includegraphics[width=4.3cm]{figures/2022_jiawen_q7_B.png}}{\includegraphics[width=4.3cm]{figures/2022_jiawen_q7_C.png}}{\includegraphics[width=4.3cm]{figures/2022_jiawen_q7_D.png}}
...
\begin{tightcenter}\begin{tabular}{|c|c|c|}\hline & 准点班次数 & 未准点班次数\\ \hline A & 240 & 20\\ \hline B & 210 & 30\\ \hline\end{tabular}\end{tightcenter}
（1）根据上表，分别估计这两家公司甲、乙两城之间的长途客车准点的概率；

（2）能否有90\%把握认为甲、乙两城之间的长途客车是否准点与客车所属公司有关？
...
\end{minipage}\hfill
\begin{minipage}[t]{0.32\linewidth}\vspace{-1.2em}\centering\includegraphics[width=\linewidth]{figures/2022_jiawen_q19.png}\end{minipage}
\item（12分）
