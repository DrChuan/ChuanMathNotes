...
\begin{tightcenter}\includegraphics[width=2.7cm]{figures/2023_yi_li_q3.png}\end{tightcenter}
...
\twochoices{\tallchoice{$\dfrac{1+\sqrt2}{2}$}}{\tallchoice{$\dfrac{1+2\sqrt2}{2}$}}{$1+\sqrt2$}{$2+\sqrt2$}
\end{examquestions}
...
（2）是否存在$a,b$，使得曲线$y=f\left(\dfrac1x\right)$关于直线$x=b$对称，若存在，求$a,b$的值，若不存在，说明理由；
