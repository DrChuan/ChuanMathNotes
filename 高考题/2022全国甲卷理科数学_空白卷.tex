...
\begin{tightcenter}\includegraphics[width=10.5cm]{figures/2022_jiali_q2.png}\end{tightcenter}
则
...
\twochoices{\tallchoice{$\dfrac{11-3\sqrt3}{2}$}}{\tallchoice{$\dfrac{11-4\sqrt3}{2}$}}{\tallchoice{$\dfrac{9-3\sqrt3}{2}$}}{\tallchoice{$\dfrac{9-4\sqrt3}{2}$}}

\end{minipage}\hfill
\begin{minipage}[t]{0.26\linewidth}
\vspace{-2.8em}\centering
\includegraphics[width=\linewidth]{figures/2022_jiali_q8.png}
\end{minipage}
...
\subq{（1）}{证明：$BD\perp PA$；}

\subq{（2）}{求 $PD$ 与平面 $PAB$ 所成的角的正弦值.}
\end{minipage}\hfill
\begin{minipage}[t]{0.22\linewidth}
\vspace{-2.6em}\centering
...
\subq{（2）}{用 $X$ 表示乙学校的总得分，求 $X$ 的分布列与期望.}
...
\subq{（1）}{若 $f(x)\geq0$，求 $a$ 的取值范围；}

\subq{（2）}{证明：若 $f(x)$ 有两个零点 $x_1,x_2$，则 $x_1x_2<1$.}
\end{examanswers}
\vspace{2em}
