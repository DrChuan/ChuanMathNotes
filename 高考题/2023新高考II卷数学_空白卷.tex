...
\begin{tightcenter}\includegraphics[width=3.5cm]{figures/2023_xgk2_q16.png}\end{tightcenter}
\end{examquestions}
...
（1）若$\angle ADC=\dfrac\pi3$，求$\tan B$；
...
\begin{tightcenter}\includegraphics[width=10cm]{figures/2023_xgk2_q19.png}\end{tightcenter}
...
（2）点$F$满足$\vec{EF}=\vec{DA}$，求二面角$D-AB-F$的正弦值. 
\end{minipage}\hfill
